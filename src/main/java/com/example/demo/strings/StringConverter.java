...
public class StringConverter {
	...
	private static final HashMap<Character, String> htmlEncodeChars2 = new HashMap<>();
	...
	private static String encode(String source, HashMap<Character, String> encodingTable) {
		...
		for (int i = 0; i < stringToEncodeArray.length; i++) {
			char charEncode = stringToEncodeArray[i];

			if (encodingTable.containsKey(charEncode)) {
				...
				encodedString.append(encodingTable.get(charEncode));
				lastMatch = i;
			}
		}
	...
	static {
		...
		htmlEncodeChars2.put('\u0026', "&amp;");
		htmlEncodeChars2.put('\u003C', "&lt;");
		htmlEncodeChars2.put('\u003E', "&gt;");
		htmlEncodeChars2.put('\u0022', "&quot;");
		htmlEncodeChars2.put('\u0152', "&OElig;");
		htmlEncodeChars2.put('\u0153', "&oelig;");
		htmlEncodeChars2.put('\u0160', "&Scaron;");
		htmlEncodeChars2.put('\u0161', "&scaron;");
		htmlEncodeChars2.put('\u0178', "&Yuml;");
		htmlEncodeChars2.put('\u02C6', "&circ;");
		htmlEncodeChars2.put('\u02DC', "&tilde;");
		htmlEncodeChars2.put('\u2002', "&ensp;");
		htmlEncodeChars2.put('\u2003', "&emsp;");
		htmlEncodeChars2.put('\u2009', "&thinsp;");
		htmlEncodeChars2.put('\u200C', "&zwnj;");
		htmlEncodeChars2.put('\u200D', "&zwj;");
		htmlEncodeChars2.put('\u200E', "&lrm;");
		htmlEncodeChars2.put('\u200F', "&rlm;");
		htmlEncodeChars2.put('\u2013', "&ndash;");
		htmlEncodeChars2.put('\u2014', "&mdash;");
		htmlEncodeChars2.put('\u2018', "&lsquo;");
		htmlEncodeChars2.put('\u2019', "&rsquo;");
		htmlEncodeChars2.put('\u201A', "&sbquo;");
		htmlEncodeChars2.put('\u201C', "&ldquo;");
		htmlEncodeChars2.put('\u201D', "&rdquo;");
		htmlEncodeChars2.put('\u201E', "&bdquo;");
		htmlEncodeChars2.put('\u2020', "&dagger;");
		htmlEncodeChars2.put('\u2021', "&Dagger;");
		htmlEncodeChars2.put('\u2030', "&permil;");
		htmlEncodeChars2.put('\u2039', "&lsaquo;");
		htmlEncodeChars2.put('\u203A', "&rsaquo;");
		htmlEncodeChars2.put('\u20AC', "&euro;");
